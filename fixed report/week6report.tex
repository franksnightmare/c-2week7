...
\subsubsection*{Semaphore 3.0, now more tidy}
...
\lstinputlisting[caption = done.cc]{src/a49/semaphore/done.cc}
\lstinputlisting[caption = empty.cc]{src/a49/semaphore/empty.cc}
...
\subsubsection*{Subscribable}
\lstinputlisting[caption = semaphore.ih]{src/a49/subscribable/subscribable.ih}
\lstinputlisting[caption = semaphore.h]{src/a49/subscribable/subscribable.h}
\lstinputlisting[caption = addthread.cc]{src/a49/subscribable/addthread.cc}
\lstinputlisting[caption = removethread.cc]{src/a49/subscribable/removethread.cc}
\lstinputlisting[caption = subscribers.cc]{src/a49/subscribable/subscribers.cc}
\lstinputlisting[caption = waiters.cc]{src/a49/subscribable/waiters.cc}

\subsubsection*{SafeRangeQueue}
\lstinputlisting[caption = semaphore.ih]{src/a49/saferangequeue/saferangequeue.ih}
\lstinputlisting[caption = semaphore.h]{src/a49/saferangequeue/saferangequeue.h}
\lstinputlisting[caption = pop.cc]{src/a49/saferangequeue/pop.cc}
\lstinputlisting[caption = push.cc]{src/a49/saferangequeue/push.cc}
\lstinputlisting[caption = queueaddthread.cc]{src/a49/saferangequeue/queueaddthread.cc}
\lstinputlisting[caption = queuedone.cc]{src/a49/saferangequeue/queuedone.cc}
\lstinputlisting[caption = queuewait.cc]{src/a49/saferangequeue/queuewait.cc}
